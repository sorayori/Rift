...
#pragma warning( pop )
        ...
        inline DWORD FindOffset(const char* VariableFullName)
        {
    ...
    {
        auto fStaticConstructObject_Internal = reinterpret_cast<void* (__fastcall*)(void*, void*, void*, int, unsigned int, void*, bool, void*, bool)>(StaticConstructObject_InternalAddr);
